...
/* package Plutus-quest-0.1.0.0 */
#ifndef VERSION_Plutus_quest
#define VERSION_Plutus_quest "0.1.0.0"
#endif /* VERSION_Plutus_quest */
#ifndef MIN_VERSION_Plutus_quest
#define MIN_VERSION_Plutus_quest(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Plutus_quest */
...
#define CURRENT_COMPONENT_ID "Plutus-quest-0.1.0.0-inplace-Plutus-quest"
